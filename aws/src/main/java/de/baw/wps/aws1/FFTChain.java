...
public class FFTChain extends AbstractAnnotatedAlgorithm{
	...
	public void executeChain(){
		...
		String fftData2[] = prepareExecute("http://kfkiserver:8080/wps/WebProcessingService","de.baw.wps.aws1.ComputeFFT",inputsFFT2, "OC");
